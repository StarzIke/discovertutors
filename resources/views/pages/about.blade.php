  ...
  <div class="container">
    <div class="row">
      <div class="grid_12 rel">
        <h1>
          <a href="index.html">
            <img src="images/logot.png" alt="Logo alt">
          </a>
        </h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="grid_12">
        ...
        <div class="extra_wrapper">
          <p class="fwn"><a href="#">Discover tutors offer access to qualifield teachers for parents,they provide flexible means of income for the tutors while providing quality and customized education.We connect a private one-on-one tutoring services accross the city of Abia State and Imo State. We look to give young people(Students) a good head-start in life by giving them confidence and inspiring them to excel in accademics and preferred career choice considering that the world has become a global village and competition for the best opportunities. <Src</Src> </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Private Lesson</a></div>
              We offer one-on-one private lessons with qualified teachers 
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Our Mission</a></div>
              To help students gain confidence and develop appropriate values and habbits necessary for excellence in accademics and in life
        ...
        <div class="grid_4">
          <div class="block-3">
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Our Vission</a></div>
              To inspire students to excel in accademics and other-wise
...
<footer id="footer">
  <div class="container">
    <div class="row">
      <div class="grid_12"> 
        <div class="copyright"><span class="brand">Discover Tutors</span> &copy; <span id="copyright-year"></span> | <a href="#">Privacy Policy</a>
